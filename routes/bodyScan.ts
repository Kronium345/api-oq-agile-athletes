...
import {
  ensureBodyScanIndexes,
  getLatestBodyScanForUser,
  listBodyScansForUser,
  saveBodyScan,
  type BodyScanRecord,
} from '../models/bodyScan.ts';
import { getUserById } from '../models/user.ts';
import {
  checkBodyScanReady,
  FormCoachError,
  MAX_BODY_SCAN_IMAGE_BYTES,
  submitBodyScan,
} from '../services/formCoachClient.ts';
import { bodyScanRateLimiter } from '../utils/bodyScanRateLimit.ts';
...
function isBodyScanEnabled(): boolean {
...
function normalizeSex(raw: unknown): 'male' | 'female' | null {
...
function weightToKg(weight: number, unit?: string | null): number {
