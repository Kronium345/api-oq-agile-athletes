...
import { buildTrainerVideoStorageKey } from "../services/trainerVideoStorage.js";
...
describe('trainerVideoStorage', () => {
    it('builds stable object keys', () => {
        assert.equal(buildTrainerVideoStorageKey('trainer-1', 'video-1'), 'trainer-videos/trainer-1/video-1.mp4');
    });
});
