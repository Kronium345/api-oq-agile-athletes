 ...
 */
export const RECOVERY_DISCLAIMER = 'This guided breathing exercise is for general wellness only. It is not medical treatment. Stop anytime if you feel dizzy or unwell, and seek professional support if symptoms worsen.';
export const BREATHING_PROTOCOLS = [
    {
        ...
        whyRecommended: 'This slow-breathing session is designed to help you unwind and may support relaxation. Individual experiences vary, and this tool is intended for general wellness rather than medical treatment.',
    ...
    },
    {
        ...
        whyRecommended: 'Even, paced breathing may support calm and focus before training or competition. Experiences vary.',
        disclaimer: RECOVERY_DISCLAIMER,
    },
    {
        ...
        whyRecommended: 'A brief double-inhale pattern may help you feel calmer during acute stress. This is a wellness tool, not a medical treatment.',
        disclaimer: RECOVERY_DISCLAIMER,
    },
    {
        id: 'sleep_wind_down',
        ...
        whyRecommended: 'Gentle slow breathing before bed may support relaxation as part of a wind-down routine. Results vary by person.',
        disclaimer: RECOVERY_DISCLAIMER,
    },
    {
        ...
        whyRecommended: 'Slow breathing after training is designed to encourage a recovery habit. It is not a measure of physiological recovery.',
        disclaimer: RECOVERY_DISCLAIMER,
    },
    {
        ...
        whyRecommended: 'A short paced-breathing set may help you settle attention before training. Evidence in sport contexts is limited; use what feels useful for you.',
        disclaimer: RECOVERY_DISCLAIMER,
    },
];
const BY_ID = new Map(BREATHING_PROTOCOLS.map((p) => [p.id, p]));
export function getBreathingProtocolById(id) {
    return BY_ID.get(id);
}
export function isKnownProtocolId(id) {
    return BY_ID.has(id);
}
export function listBreathingProtocols() {
