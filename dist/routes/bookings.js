...
import { createBooking, getBookingById, listBookingsForUser, updateBooking, } from "../models/booking.js";
import { getSlotById, markSlotAvailable, markSlotUnavailable } from "../models/bookingSlot.js";
import { getTrainerProfileById, getTrainerProfileByUserId } from "../models/trainerProfile.js";
import { createBookingPaymentIntent, getPlatformCommissionPercent, getStripe, } from "../services/stripeConnect.js";
...
router.get('/me', authenticate, async (req, res) => {
    try {
        ...
        const bookings = await listBookingsForUser(req.userId, trainerProfile?.trainerId ?? null);
    ...
    try {
        ...
        if (stripe &&
            ...
            try {
                ...
                console.warn('[bookings] refund failed:', refundErr.message);
            }
        }
