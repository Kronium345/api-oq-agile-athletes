...
export function welcomeEmailLogoUrl() {
...
export function buildEmailBannerRow(logoUrl, pageBg, alt) {
...
function buildWelcomeEmailHtml(userName, appLink) {
