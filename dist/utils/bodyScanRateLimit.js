import { countBodyScansSince } from "../models/bodyScan.js";
const DEFAULT_MAX = Number(process.env.BODY_SCAN_RATE_LIMIT_PER_DAY || 8);
const WINDOW_MS = 24 * 60 * 60 * 1000;
export async function bodyScanRateLimiter(req, res, next) {
    ...
    try {
        ...
        console.error('[body-scan] rate limit check failed:', err.message);
        next();
    }
}
