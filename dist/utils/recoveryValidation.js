...
function asOptionalNumber(value, field, min, max) {
...
function asIso(value, field, required) {
    if (value === undefined || value === null || value === '') {
        if (required) {
...
export function validateRecoverySessionBody(body) {
    const errors = [];
    const protocolId = typeof body.protocolId === 'string' ? body.protocolId.trim().toLowerCase() : '';
...
export function resolveSummaryPeriod(value) {
